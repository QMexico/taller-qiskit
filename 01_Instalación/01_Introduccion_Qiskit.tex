...
\newpage\justify\setlength{\parskip}{5mm}
\begin{frame}\frametitle{Librerías en Python} 
Como ejemplo serian Aer, Aqua, Terra, entre otros que serán abarcados a lo largo de este curso.Para esta introducción estaremos manejando los simuladores de Aer mediante la IDE de PyCharm, la cual es la recomendada para trabajar esta parte del curso aunque si se desea usar otra IDE es perfectamente válido.
...
Para empezar a trabajar los circuitos cuánticos con Qiskit, deberemos llamar a las librerías con las que realizaremos nuestro primer circuito cuántico, para ello debemos definir lo siguiente en nuestra IDE.
 ...
 \frametitle{Elementos en Qiskit} 
     ...
     Es la libreria con la que podemos agregar los cúbits que necesitemos para nuestro trabajo, a partir de aqui podremos cambiarlos de signo, rotarlos, entre muchas otras acciones hasta cambiar las magnitudes de su estado.
   ...
   \frametitle{Elementos en Qiskit} 
    ...
    Es la librería con la que podemos agregar los circuitos cuánticos que necesitemos en nuestro trabajo a partir de los cúbits o bits clásicos registrados con anterioridad.
